import { Avatar, Button, Paper, Divider, Typography, Box, Drawer, useMediaQuery } from "@mui/material";
      ...
      {cart.length > 0 ?
        <Box sx={{ p: 4 }}
          ...
          <Typography variant="body1" color={Colors.muted}>
            {""}
            shop description and any discount offers
          </Typography>
          <Paper
            elevation={0}
            sx={{
        ...
        alignItems="center"
        >
          <Typography variant={matches ? "h3" : "h5"} color={Colors.black}>
            Your cart is empty!
          </Typography>
        </Box>}
